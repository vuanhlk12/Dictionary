		...
		try {
			while (loop) {
				...
				case 5://gg
					...
					item = input.nextLine();
					try {
						System.out.println(GoogleTranslate.translate("en", "vi", item));// có thể thay đổi "en", "vi" thành các ngôn ngữ khác
				...
				case 6://gg
					Voice b;
					System.out.println("Nhập từ tiếng anh hoặc tiếng việt: ");// hoặc nhập bất kì ngôn ngữ nào google hỗ trợ cũng phát âm được
					input = new Scanner(System.in);
					item = input.nextLine();
					b = new Voice();
					b.setLine(item);
