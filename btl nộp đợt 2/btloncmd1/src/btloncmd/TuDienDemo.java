...
public class TuDienDemo {
        ...
        try {
            ...
            try {
                while (sc.hasNextLine()) {
                    ...
                    word.add("#" + str[1] + "#" + str[2] + "#" + str[3] + "#" + str[4]);
                    i++;
                }
            } catch (Exception e) {
    ...
    public String info(String resulf1){
        String stri[]=resulf1.split("#");
        return "Nghĩa:  " + stri[4] + "\n\nCách đọc:  "+stri[3]+"\n\nLoại từ:  "+stri[2];
    }
    ...
    public void add(String tu, String nghia, String loai, String cachdoc) {
        ...
        word.add("#" + tu + "#" + nghia + "#" + loai + "#" + cachdoc);
        Collections.sort(word);
